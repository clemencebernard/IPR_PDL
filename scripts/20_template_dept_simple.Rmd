...
```{r fig8, fig.width = 10, fig.height = fig_haut_reg_poissons, fig.cap = "Evolution interannuelle des densités en poissons dans le département."}
g <- reg_dept_capt %>% 
