...
Ce graphique reprend les notes IPR calculées depuis 2007, date à laquelle le protocole a été modifié et appliquer. 
...
Sur ce premier histogramme, on peut voir le nombre de fois où une espèce a été observée dans le département pour l’année `r  params$mon_annee`. 

Sur le deuxième, c’est la biomasse spécifique totale qui est mise en évidence pour la saison de pêche `r  params$mon_annee`. 
